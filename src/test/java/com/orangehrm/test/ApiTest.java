...
public class ApiTest {
	...
	public void verifyGetUserAPI() {
		...
		ExtentManager.logSteps("API Endpoint: " + endPoint);

		// Step2: Send GET Request
		ExtentManager.logSteps("Sending GET Request to the API");
		Response response = ApiUtility.sendGetrequest(endPoint);

		// Step3: validate status code
		ExtentManager.logSteps("Validating API Response status code");
		...
		ExtentManager.logSteps("Validating response body for username");
		...
		ExtentManager.logSteps("Validating response body for email");
